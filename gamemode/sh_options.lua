...
-- Tier 1
GM:AddPointShopItem("pshtr",			ITEMCAT_GUNS,			30,				"weapon_zs_peashooter", nil, nil, nil, function(pl) pl:GiveEmptyWeapon("weapon_zs_peashooter") end)
GM:AddPointShopItem("btlax",			ITEMCAT_GUNS,			30,				"weapon_zs_battleaxe", nil, nil, nil, function(pl) pl:GiveEmptyWeapon("weapon_zs_battleaxe") end)
GM:AddPointShopItem("owens",			ITEMCAT_GUNS,			30,				"weapon_zs_owens", nil, nil, nil, function(pl) pl:GiveEmptyWeapon("weapon_zs_owens") end)
GM:AddPointShopItem("blstr",			ITEMCAT_GUNS,			30,				"weapon_zs_blaster", nil, nil, nil, function(pl) pl:GiveEmptyWeapon("weapon_zs_blaster") end)
GM:AddPointShopItem("tossr",			ITEMCAT_GUNS,			30,				"weapon_zs_tosser", nil, nil, nil, function(pl) pl:GiveEmptyWeapon("weapon_zs_tosser") end)
GM:AddPointShopItem("stbbr",			ITEMCAT_GUNS,			30,				"weapon_zs_stubber", nil, nil, nil, function(pl) pl:GiveEmptyWeapon("weapon_zs_stubber") end)
GM:AddPointShopItem("crklr",			ITEMCAT_GUNS,			30,				"weapon_zs_crackler", nil, nil, nil, function(pl) pl:GiveEmptyWeapon("weapon_zs_crackler") end)
GM:AddPointShopItem("sling",			ITEMCAT_GUNS,			30,				"weapon_zs_slinger", nil, nil, nil, function(pl) pl:GiveEmptyWeapon("weapon_zs_slinger") end)
GM:AddPointShopItem("z9000",			ITEMCAT_GUNS,			30,				"weapon_zs_z9000", nil, nil, nil, function(pl) pl:GiveEmptyWeapon("weapon_zs_z9000") end)
GM:AddPointShopItem("minelayer",		ITEMCAT_GUNS,			30,				"weapon_zs_minelayer", nil, nil, nil, function(pl) pl:GiveEmptyWeapon("weapon_zs_minelayer") end)
-- Tier 2
GM:AddPointShopItem("glock3",			ITEMCAT_GUNS,			75,				"weapon_zs_glock3")
GM:AddPointShopItem("magnum",			ITEMCAT_GUNS,			75,				"weapon_zs_magnum")
GM:AddPointShopItem("eraser",			ITEMCAT_GUNS,			75,				"weapon_zs_eraser")
GM:AddPointShopItem("sawedoff",			ITEMCAT_GUNS,			75,				"weapon_zs_sawedoff")
GM:AddPointShopItem("uzi",				ITEMCAT_GUNS,			75,				"weapon_zs_uzi")
GM:AddPointShopItem("annabelle",		ITEMCAT_GUNS,			75,				"weapon_zs_annabelle")
GM:AddPointShopItem("inquisitor",		ITEMCAT_GUNS,			75,				"weapon_zs_inquisitor")
GM:AddPointShopItem("amigo",			ITEMCAT_GUNS,			75,				"weapon_zs_amigo")
GM:AddPointShopItem("hurricane",		ITEMCAT_GUNS,			75,				"weapon_zs_hurricane")
GM:AddPointShopItem("nome",		        ITEMCAT_GUNS,			75,				"weapon_zs_nome")
GM:AddPointShopItem("popl",		        ITEMCAT_GUNS,			75,				"weapon_zs_popluttar")
GM:AddPointShopItem("fracture",		        ITEMCAT_GUNS,			75,				"weapon_zs_fracture")
-- Tier 3
...
GM:AddPointShopItem("hyena",			ITEMCAT_GUNS,			150,				"weapon_zs_hyena")
...
-- Tier 4
GM:AddPointShopItem("longarm",			ITEMCAT_GUNS,		    250,			"weapon_zs_longarm")
GM:AddPointShopItem("sweeper",			ITEMCAT_GUNS,		    250,			"weapon_zs_sweepershotgun")
GM:AddPointShopItem("jackhammer",		ITEMCAT_GUNS,		    250,			"weapon_zs_jackhammer")
GM:AddPointShopItem("bulletstorm",		ITEMCAT_GUNS,		    250,			"weapon_zs_bulletstorm")
GM:AddPointShopItem("reaper",			ITEMCAT_GUNS,		    250,			"weapon_zs_reaper")
GM:AddPointShopItem("quicksilver",		ITEMCAT_GUNS,		    250,			"weapon_zs_quicksilver")
GM:AddPointShopItem("slugrifle",		ITEMCAT_GUNS,		    250,			"weapon_zs_slugrifle")
GM:AddPointShopItem("artemis",			ITEMCAT_GUNS,		    250,			"weapon_zs_artemis")
GM:AddPointShopItem("zeus",				ITEMCAT_GUNS,		    250,			"weapon_zs_zeus")
GM:AddPointShopItem("stalker",			ITEMCAT_GUNS,		    250,			"weapon_zs_m4")
GM:AddPointShopItem("inferno",			ITEMCAT_GUNS,		    250,			"weapon_zs_inferno")
GM:AddPointShopItem("quasar",			ITEMCAT_GUNS,		    250,			"weapon_zs_quasar")
GM:AddPointShopItem("gluon",			ITEMCAT_GUNS,		    250,			"weapon_zs_gluon")
GM:AddPointShopItem("barrage",			ITEMCAT_GUNS,		    250,			"weapon_zs_barrage")
GM:AddPointShopItem("classixg",			ITEMCAT_GUNS,		    250,			"weapon_zs_classic")
GM:AddPointShopItem("toxico",			ITEMCAT_GUNS,		    250,			"weapon_zs_toxicshooter")
GM:AddPointShopItem("gaysseagle",   	ITEMCAT_GUNS,		    250,			"weapon_zs_gaeagle")
-- Tier 5
GM:AddPointShopItem("novacolt",			ITEMCAT_GUNS,		    400,			"weapon_zs_novacolt")
GM:AddPointShopItem("bulwark",			ITEMCAT_GUNS,		    400,			"weapon_zs_bulwark")
...
GM:AddPointShopItem("boomstick",		ITEMCAT_GUNS,		    400,			"weapon_zs_boomstick")
GM:AddPointShopItem("deathdlrs",		ITEMCAT_GUNS,		    400,			"weapon_zs_deathdealers")
GM:AddPointShopItem("colossus",			ITEMCAT_GUNS,		    400,			"weapon_zs_colossus")
GM:AddPointShopItem("renegade",			ITEMCAT_GUNS,		    400,			"weapon_zs_renegade")
GM:AddPointShopItem("crossbow",			ITEMCAT_GUNS,		    400,			"weapon_zs_crossbow")
GM:AddPointShopItem("pulserifle",		ITEMCAT_GUNS,		    400,			"weapon_zs_pulserifle")
GM:AddPointShopItem("spinfusor",		ITEMCAT_GUNS,		    400,			"weapon_zs_spinfusor")
GM:AddPointShopItem("broadside",		ITEMCAT_GUNS,		    400,			"weapon_zs_broadside")
GM:AddPointShopItem("smelter",			ITEMCAT_GUNS,		    400,			"weapon_zs_smelter")
GM:AddPointShopItem("plasmk",			ITEMCAT_GUNS,		    400,			"weapon_zs_plasmatik")
-- Tier 6 beta
GM:AddPointShopItem("null",			ITEMCAT_GUNS,			40,			"weapon_zs_null")
...
GM:AddPointShopItem("nailsz",			ITEMCAT_AMMO,			4,				nil,			"8 nails",						nil, 		"ammo_nail", 			function(pl) pl:GiveAmmo(8, "GaussEnergy", true) end)

item.NoClassicMode = true
-- Tier 1
GM:AddPointShopItem("brassknuckles",	ITEMCAT_MELEE,			30,				"weapon_zs_brassknuckles").Model = "models/props_c17/utilityconnecter005.mdl"
GM:AddPointShopItem("knife",			ITEMCAT_MELEE,			15,				"weapon_zs_swissarmyknife")
GM:AddPointShopItem("zpplnk",			ITEMCAT_MELEE,			30,				"weapon_zs_plank")
GM:AddPointShopItem("axe",				ITEMCAT_MELEE,			30,				"weapon_zs_axe")
GM:AddPointShopItem("zpfryp",			ITEMCAT_MELEE,			30,				"weapon_zs_fryingpan")
GM:AddPointShopItem("zpcpot",			ITEMCAT_MELEE,			30,				"weapon_zs_pot")
GM:AddPointShopItem("ladel",			ITEMCAT_MELEE,			30,				"weapon_zs_ladel")
GM:AddPointShopItem("pipe",				ITEMCAT_MELEE,			30,				"weapon_zs_pipe")
GM:AddPointShopItem("stunbaton",		ITEMCAT_MELEE,			30,				"weapon_zs_stunbaton")
GM:AddPointShopItem("hook",				ITEMCAT_MELEE,			30,				"weapon_zs_hook")
GM:AddPointShopItem("syx",				ITEMCAT_MELEE,			30,				"weapon_zs_syx")
-- Tier 2
...
GM:AddPointShopItem("harpoon",			ITEMCAT_MELEE,			45,				"weapon_zs_harpoon")
GM:AddPointShopItem("butcherknf",		ITEMCAT_MELEE,			45,				"weapon_zs_butcherknife")
GM:AddPointShopItem("keyboard",		    ITEMCAT_MELEE,			30,				"weapon_zs_keyboard")
GM:AddPointShopItem("dash",		    ITEMCAT_MELEE,			45,				"weapon_zs_f_dash")
-- Tier 3
GM:AddPointShopItem("longsword",		ITEMCAT_MELEE,			80,				"weapon_zs_longsword")
GM:AddPointShopItem("executioner",		ITEMCAT_MELEE,			80,				"weapon_zs_executioner")
GM:AddPointShopItem("rebarmace",		ITEMCAT_MELEE,			80,				"weapon_zs_rebarmace")
GM:AddPointShopItem("meattenderizer",	ITEMCAT_MELEE,			80,				"weapon_zs_meattenderizer")
GM:AddPointShopItem("iceeluxx",	ITEMCAT_MELEE,			80,				"weapon_zs_icelux")
-- Tier 4
...
-- Tier 5
GM:AddPointShopItem("frotchet",			ITEMCAT_MELEE,			115,			"weapon_zs_frotchet")
GM:AddPointShopItem("luxrockj",			ITEMCAT_MELEE,			115,			"weapon_zs_luxshade")
GM:AddPointShopItem("xouryc",			ITEMCAT_MELEE,			350,			"weapon_zs_loy")
GM:AddPointShopItem("speed",			ITEMCAT_MELEE,			12000,			"weapon_zs_speed")
GM:AddPointShopItem("luxoid",			ITEMCAT_MELEE,			350,			"weapon_zs_luxoid")
GM:AddPointShopItem("megahook",			ITEMCAT_MELEE,			350,			"weapon_zs_harpoon_mega")
-- Super Trinkets ------------------------------------------------------------------------------------------------------------------------------------------------
GM:AddPointShopItem("futureblu",			ITEMCAT_SUPER,			450,			"trinket_futureblu")
GM:AddPointShopItem("sman",			ITEMCAT_SUPER,			450,			"trinket_sman")
GM:AddPointShopItem("stutor",			ITEMCAT_SUPER,			450,			"trinket_stutor")
GM:AddPointShopItem("gstore",			ITEMCAT_SUPER,			450,			"trinket_gstore")
